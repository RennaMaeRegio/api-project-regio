...
function DataForm() {
    ...
    useEffect(() => { 
        axios.get('https://astounding-fairy-cbec11.netlify.app/.netlify/functions/api/') 
            .then((response) => { 
    ...
    const handleSubmit = (e, id = null) => { 
        ...
        const url = editItem 
            ? `https://astounding-fairy-cbec11.netlify.app/.netlify/functions/api/${editItem._id}`
            : 'https://astounding-fairy-cbec11.netlify.app/.netlify/functions/api/';
    ...
    const handleDelete = (_id) => { 
        axios 
            .delete(`https://astounding-fairy-cbec11.netlify.app/.netlify/functions/api/${_id}`) 
            .then(() => { 
